...
The compiled paper is [published on SSRN](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=7114559) and the analysis pipeline that produces every number in it is in this repo.
