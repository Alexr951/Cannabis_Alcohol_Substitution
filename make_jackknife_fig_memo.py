# Builds Results/figures/fig_n9_power_3rules.pdf and Results/JACKKNIFE_MEMO.md
# from the CSVs written by R/11_power_jackknife.R. No number is hand-typed.
import os
...
Generated by `make_jackknife_fig_memo.py` from `Results/csv/`; produced by
...
fig_power_3rules()
make_memo()
print('wrote Results/figures/fig_n9_power_3rules.pdf and Results/JACKKNIFE_MEMO.md')
